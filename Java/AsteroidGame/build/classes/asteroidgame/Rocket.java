...
public class Rocket extends PolyBlob implements BlobAction, BlobProximity {
    ...
    private final int x1[] = {10, 10, 8, 7, -2, -2, -6, -5, -6, -2, -2, 7, 8};
    private final int y1[] = {0, 2, 3, 2, 2, 5, 5, 0, -5, -5, -2, -2, -3};
    
    private double angle = 0.0;
    private final double delta = 0.15;
    private final double speed = 5.0;
    
    private final int xRef[] = {10, 10, 8, 7, -2, -2, -6, -5, -6, -2, -2, 7, 8};
    private final int yRef[] = {0, 2, 3, 2, 2, 5, 5, 0, -5, -5, -2, -2, -3};
